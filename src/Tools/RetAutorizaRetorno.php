...
class RetAutorizaRetorno extends Retorno
{
    /**
     * XML do retorno.
     *
    ...
    /**
     * RetAutorizaRetorno constructor.
     * @param XML $retorno
     * @param XML $xml
     */
    public function __construct(XML $retorno, XML $xml)
    {
        ...
        $this->xml = $xml;
        $this->infProt = $this->retorno->getElementsByTagName('protNFe')->item(0);
    }
    ...
    public function getXML()
    {
        ...
        $versao = $this->retorno->getElementsByTagName('retConsReciNFe')->item(0)->getAttribute('versao');
        $urlPortal = $this->retorno->getElementsByTagName('retConsReciNFe')->item(0)->getAttribute('xmlns');
